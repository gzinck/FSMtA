...
public class NonDetObsFSM extends NonDetFSM implements Observability<NonDetTransition, ObservableEvent>{
...
//---  Operations   ---------------------------------------------------------------------------
	...
	@Override
	public FSM<NonDetTransition, ObservableEvent> createObserverView() {
