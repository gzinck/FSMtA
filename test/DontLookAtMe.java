...
////		File f1 = new File(GRAEME_WORKING_FOLDER + "/fil1.fsm");
		File f = new File("/Users/graemezinck/Documents/OneDrive/Documents/Work/2018 Summer Research/GraphViz/FSMI2/cantdeterminize.fsm");
...
//		FSMToDot.createImgFromFSM(fsm3, GRAEME_WORKING_FOLDER + "test4", GRAEME_WORKING_FOLDER, GRAEME_CONFIG_FILE_PATH);
		...
		DetObsContFSM fsm1 = new DetObsContFSM(f, "OK");
